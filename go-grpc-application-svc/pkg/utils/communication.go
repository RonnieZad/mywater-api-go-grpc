...
func GenerateRandomString() string {
	...
	num := rand.Intn(900) + 100             // Generate a random number between 100 and 999
	letter := rune(rand.Intn(26) + 'A')     // Generate a random letter between A and Z
	return fmt.Sprintf("%d%c", num, letter) // Combine the number and letter to form a string
}
